    ...
    return Scaffold(
      appBar: AppBar(
        title: Consumer<SessionController>(
          builder: (context, session, _) => Text(session.user?.nama ?? 'Marketing'),
        ),
        actions: [
          IconButton(
  ...
  Widget build(BuildContext context) {
    return Consumer<SessionController>(
      builder: (context, session, _) {
        ...
        final kpi = data['marketing_kpi'] as Map<String, dynamic>? ?? {};
        ...
        return RefreshIndicator(
          ...
          child: ListView(
            ...
            children: products.isEmpty
                ? [const _SectionCard(title: 'Product Knowledge', children: [Text('Belum ada data.')])]
                : products
