...
import 'package:flutter_sweetie_app/src/screens/login_screen.dart';
import 'package:flutter_sweetie_app/src/services/api_client.dart';
import 'package:flutter_sweetie_app/src/services/session_store.dart';
import 'package:flutter_sweetie_app/src/state/session_controller.dart';
  ...
  Widget build(BuildContext context) {
    return Consumer<SessionController>(
      builder: (context, session, _) {
        ...
        return Scaffold(
          appBar: AppBar(
            title: Text(session.user?.nama ?? 'Sweetie'),
            actions: [
              IconButton(
