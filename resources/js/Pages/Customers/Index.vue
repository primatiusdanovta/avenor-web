            ...
            <div class="card card-outline card-success">
                ...
                <div class="card-body p-0 table-responsive">
                    <table class="table table-hover mb-0">
                        <thead><tr><th>Nama</th><th>No Telp</th><th>Tiktok / Instagram</th><th>Dibuat</th><th>Pembelian Terakhir</th><th>Aksi</th></tr></thead>
                        <tbody>
                            ...
                            <tr v-if="!customers.length"><td colspan="6" class="text-center text-muted">Belum ada data pelanggan.</td></tr>
                        </tbody>
                    </table>
                </div>
            </div>
