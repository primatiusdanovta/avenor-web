<template>
    ...
    <BootstrapModal :show="showCreateModal" title="Tambah Raw Material" size="lg" @close="closeCreateModal">
        <div class="crud-modal-body">
            ...
            <div v-if="String(createForm.satuan).toLowerCase() === 'kg'" class="small text-muted">Input kg akan otomatis disimpan sebagai gram agar perhitungan HPP dan pengurangan stok lebih presisi.</div>
    ...
    <BootstrapModal :show="showEditModal" title="Edit Raw Material" size="lg" @close="closeEditModal">
        <div class="crud-modal-body">
            ...
            <div v-if="String(editForm.satuan).toLowerCase() === 'kg'" class="small text-muted">Input kg akan otomatis disimpan sebagai gram agar perhitungan HPP dan pengurangan stok lebih presisi.</div>
